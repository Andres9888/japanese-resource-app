  ...
  return (
    <Background>
      <Container>
        ...
        <p>
          Studying Japanese is hard but everyone can come become fluent and achieve their goals. The most improve part is that you stay consistent ,
          make it a habit , and keep yourself motivated.
        </p>
        <p>
